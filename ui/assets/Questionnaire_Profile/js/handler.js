var questionBox=function(questionId,userQuestion,wishQuestion,answers){
    ...
    $(".userQuestion").html(userQuestion.replace(/\'/gi,''));
    $(".wishQuestion").html(wishQuestion.replace(/\'/gi,''));
    ...
    $.each(answers,function(index,value){
      // console.log(answers[-1].answer);
        ...
        //   );
        var option=$("<option></option>").attr("value",value.answerId).text(value.answer.replace(/\'/gi,''));

...
func (userQ *UserQuestionnarieHandler) MainQuestionnarie(w http.ResponseWriter, r *http.Request) {
	...
	userQ.tmpl.ExecuteTemplate(w, "user_form", id)
}

func (userQ *UserQuestionnarieHandler) PostAnswers(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	...
	user.UserId, _ = strconv.Atoi(p.ByName("user_id"))
